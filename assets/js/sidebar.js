...
export function sidebar() {
  ...
  <div class="sidebar-footer">
    <p class="copyright"><a href="https://twitter.com/AfrizalStyle">Made with  by Afrizal Developer</a>
    </p>
    <div class="social-link">
    <a href="https://twitter.com/AfrizalStyle" alt="Social handles" target="_blank">Twitter</a>
    <a href="https://github.com/afrizaldeveloper/afrizaldeveloper" alt="Social handles" target="_blank">Github</a>
    <a href="https://www.instagram.com/afrizalrizkyajaya/" alt="Social handles" target="_blank">Instagram</a>
    </div>
  </div>
`;
